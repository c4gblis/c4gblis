...
class PageElems
{
	...
	public function getTestTypeTable()
	{
		...
		<?php
		$ttype_list = get_test_types_catalog();
	...
	public function getSpecimenTypeTable()
	{
		...
		$stype_list = get_specimen_types_catalog();
...
public function getTestsDoneStatsTable($stat_list)
	...
	public function getDoctorStatsTable($stat_list)
	{
...
$name_list = array("yyyy_to".$count, "mm_to".$count, "dd_to".$count);
	...
	public function getSpecimenTypeCheckboxes($lab_config_id="")
	{
		# Returns a set of checkboxes with existing specimen types checked
		$lab_config = get_lab_config_by_id($lab_config_id);
		...
		<table class='hor-minimalist-b' style='width:700px;'>
			...
			foreach($specimen_list as $key=>$value)
			{
				...
				{
					?>
					<span class='clean-ok'><?php echo $specimen_name; ?></span>
					<?php
				}
				else
					echo $specimen_name;
	...
	public function getTestTypeCheckboxes($lab_config_id="")
	{
	...
	public function getCompatibilityJsArray($array_name)
	{
