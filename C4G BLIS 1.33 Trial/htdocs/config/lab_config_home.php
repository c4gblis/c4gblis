...
function language_div_load() {
	...
	$('.menu_option').removeClass('current_menu_option');
	$('#language_div').show();
	$('#option15').addClass('current_menu_option');
}
	...
	<tbody>
		<tr valign='top'>
			<td class='left_menu' id='left_pane' width='160px'><ul>
				...
				<br><br>
				<a id='option15' class='menu_option' href="javascript:language_div_load();"><?php echo LangUtil::getPageTerm("MODIFYLANG"); ?></a>
				<br><br>
			...
			<td>
				...
				<div class='right_pane' id='update_database_div' style='display:none;margin-left:10px;'>
					...
					<br><br>
					<div class='clean-orange' id='revert_done_msg' style='width:300px; display:none;'>
						<?php echo LangUtil::$pageTerms['TIPS_REVERTDONE']; ?>
					</div>
				</div>
			</td>
